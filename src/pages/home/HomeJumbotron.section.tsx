  ...
  return (
    <Stack className="mt-20 self-center pb-10 mb-20 w-full gap-0">
        ...
        <Stack className="relative self-end w-[62%] flex-col-reverse h-full">
          <Stack className="gap-10 z-10 w-full self-end">
            <Stack className="gap-0 items-center z-10 w-full pb-10">
              ...
              <Text className="font-poppins-semibold text-[38px] md:text-[50px] lg:text-[60px] tracking-4 text-pastel-primary-text z-10 text-center bg-white/[0.75]">
                KUESIONER
              </Text>
              <Text className="font-poppins-semibold text-[38px] md:text-[50px] lg:text-[60px] tracking-4 text-pastel-primary-text z-10 text-center bg-white/[0.75] -mt-4">
                KECEMASAN SOSIAL
              </Text>
              <Text className="font-poppins-semibold text-[38px] md:text-[50px] lg:text-[60px] tracking-4 text-pastel-primary-text z-10 text-center bg-white/[0.75] -mt-4">
                PADA SISWA SMA
      ...
      <Stack className="bg-primaryDarkBlue px-20 py-2">
        <div className="self-end w-24 md:w-32">
          <Image src={uinLogo} />
        </div>
      </Stack>
    </Stack>
